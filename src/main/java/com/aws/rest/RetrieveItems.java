...
public class RetrieveItems {
    ...
    public List<com.aws.entities.WorkItem> getItemsDataSQLReport(int arch) {

        RdsDataClient dataClient = getClient();
        String username = "User";
        List<com.aws.entities.WorkItem>records = new ArrayList<>();
        ...
        try {
            ...
            com.aws.entities.WorkItem workItem ;
            int index = 0 ;
            ...
            for (List list: dataList) {
                ...
                // New WorkItem object.
                workItem = new com.aws.entities.WorkItem();
                index = 0;
